...
public class ConfirmButton : MonoBehaviour
{
    ...
    private void SaveData()
    {
        ...
        PlayerDataManager.Instance.playerData = new PlayerData(playerName.text, npcName.text, playerGenderValue, npcGenderValue, relationshipValue,characteristic1.value, characteristic2.value,characteristic3.value, 100, 100, 0, 0,0);
